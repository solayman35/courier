			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
                                    ...
                                    $dataCost=$admin->get_cost_by_id($_GET['id']);
                                    $rowCost= mysqli_fetch_array($dataCost);
                                            if($_SERVER['REQUEST_METHOD']=='POST'){
                                        extract($_POST);
                                        print_r($_POST);
                                        $data=$admin->updateCost($from_upazila, $to_upazila,$cost,$_GET['id']);
                                        
                                        if($data){
                                            echo "Update Cost Successfully";
                                            
                                             echo("<script>location.href = 'manage-cost.php ';</script>");
                                        }
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <label class="control-label" for="selectError3">From Upazila</label>
								<div class="controls">
                                                                    <select id="from_upazila" name="from_upazila">
                                                                         <option value="<?PHP echo $rowCost['from_id'] ?>"><?PHP if(isset($rowCost)) echo $rowCost['fromname'] ?></option>
							  ...
							  <label class="control-label" for="selectError3">To Upazila</label>
								<div class="controls">
                                                                    <select id="to_upazila" name="to_upazila">
                                                                        <option value="<?PHP echo $rowCost['to_id'] ?>"><?PHP if(isset($rowCost)) echo $rowCost['toname'] ?></option>
							  ...
							  <div class="controls">
                                                              <input type="text" name="cost" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" value="<?PHP if(isset($rowCost)) echo $rowCost['cost'] ?>" >
...
<script type="text/javascript">
   ...
   document.forms['myform'].elements['from_dist'].value='<?PHP echo $rows['district_id'] ?>'
</script>
</body>
</html>
